// src/lib.rs
/*
 * Core library for SolverProblem
 */
...
#[derive(Debug)]
pub struct SolverProblemProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SolverProblemProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SolverProblem processing");
    
    let mut processor = SolverProblemProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SolverProblemProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SolverProblemProcessor::new(false);
